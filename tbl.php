        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <h1 class="mt-4">Tutupbon Langsung</h1>
                                ...
                                <table class="table table-bordered table-striped" id="orderdesc" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['monthsubmit'])) {
                                            ...
                                            $tampilantbl = mysqli_query($conn, "select * from tbl left join login on tbl.id_login=login.id_login left join company on tbl.id_company=company.id_company where month(tanggal_tbl)=$for_date order by tanggal_tbl");
                                        } else {
