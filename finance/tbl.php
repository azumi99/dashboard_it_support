                                ...
                                <table class="table table-bordered table-striped" id="orderdesc" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['monthsubmit'])) {
                                            ...
                                            $tampilantbl = mysqli_query($conn, "select * from tbl left join login on tbl.id_login=login.id_login left join company on tbl.id_company=company.id_company where tbl.id_company='$sesion' and month(tanggal_tbl)=$indate[0] and year(tanggal_tbl)=$indate[1] order by tanggal_tbl");
                                        } else {
