                                ...
                                <table class="table table-bordered table-striped" id="orderdesc" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['monthsubmit'])) {
                                            ...
                                            $tampilantb = mysqli_query($conn, "select * from tb left join login on tb.id_login=login.id_login left join kb on tb.id_kb=kb.id_kb left join company on kb.id_company=company.id_company WHERE kb.id_company=$sesion and month(tanggal_tb)=$indate[0] and year(tanggal_tb)=$indate[1] order by tanggal_tb");
                                        } else {
                                            $tampilantb = mysqli_query($conn, "select * from tb left join login on tb.id_login=login.id_login left join kb on tb.id_kb=kb.id_kb left join company on kb.id_company=company.id_company WHERE kb.id_company=$sesion ");
                                        };
                                        ...
                                        ?>
                                            ...
                                            <!-- modal update tb -->
                                            <!-- update modal -->
                                            <div class="modal fade" id="terimatb<?= $idtb; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Tutup Bon di Terima Oleh :</h5>
                                                        ...
                                                        <form method="POST">
                                                            <div class="modal-body">
                                                                ...
                                                                <br />
                                                                <button type="submit" name="sudahtrmtb" class="btn btn-success">Oke ,di Terima</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
