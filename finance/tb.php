                                ...
                                <table class="table table-bordered table-striped" id="orderdesc" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['monthsubmit'])) {
                                            ...
                                            $tampilantb = mysqli_query($conn, "select * from tb left join login on tb.id_login=login.id_login left join kb on tb.id_kb=kb.id_kb left join company on kb.id_company=company.id_company WHERE kb.id_company=$sesion and month(tanggal_tb)=$for_date order by tanggal_tb");
                                        } else {
