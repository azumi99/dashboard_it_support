                ...
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-light text-info border-0 shadow p-3 mb-5 rounded mb-4">
                                        <div class="card-body">
                                            <h1><i class="fas fa-exchange-alt"></i> <b class="float-right"><?= $hitungkb2; ?></b></h1>
                                        </div>
                                        <div>
                                            KB Belum Transfer
                                            <a href="kb" class="btn btn-info btn-sm">more</a>
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-light text-info border-0 shadow p-3 mb-5 rounded mb-4">
                                        <div class="card-body">
                                            <h1><i class="far fa-bookmark"></i> <b class="float-right"><?= $hitungtb3; ?></b></h1>
                                        </div>
                                        <div>
                                            TB Belum Diterima
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-light text-info border-0 shadow p-3 mb-5 rounded mb-4">
                                        <div class="card-body">
                                            <h1><i class="fas fa-exchange-alt"></i> <b class="float-right"><?= $hitungtbl5; ?></b></h1>
                                        </div>
                                        <div>
                                            TBL Belum Transfer
                                ...
                                <div class="col-md-4">
                                    <div class="card bg-light text-info border-0 shadow p-3 mb-5 rounded mb-4">
                                        <div class="card-body">
                                            <h1><i class="far fa-bookmark"></i> <b class="float-right"><?= $hitungtbl4; ?></b></h1>
                                        </div>
                                        <div>
                                            TBL Belum Diterima
                                            <a href="tbl" class="btn btn-info btn-sm">more</a>
                    ...
                    <div class="card border-0 shadow p-3 mb-2 rounded mb-2">
                        <div class="card-header border-0 shadow p-3 mb-2 rounded mb-2">
                            ...
                            <a href="#addaccount" data-toggle="collapse" class="float-right" aria-expanded="false" aria-controls="collapseExample"><i class="fas fa-chevron-down"></i></a>
                        </div>
                        <div class="card-body collapse" id="addaccount">
                            <div class="row">
                                <div class="col-md-6 mb-6">
                                    <div class="card">
                                        <a class="btn btn-info btn-lx" data-toggle="collapse" href="#itsupport" role="button" aria-expanded="false" aria-controls="collapseExample">
                                ...
                                <div class="col-md-6 mb-6">
                                    <div class="card">
                                        <a class="btn btn-info btn-lx" data-toggle="collapse" href="#finance" role="button" aria-expanded="false" aria-controls="collapseExample">
                                            Add Account Finance
                                        </a>
                    ...
                    <div class="card border-0 shadow p-3 mb-2 rounded mb-2 ">
                        ...
                        <div class="card-body collapse" id="addcompany">
                            <div class="row">
                                <div class="col-md-6 mb-6">
                                    <div class="card">
                                        <a class="btn btn-info btn-lx" data-toggle="collapse" href="#addcompany" role="button" aria-expanded="false" aria-controls="collapseExample">
                                            Add Company
                                        </a>
